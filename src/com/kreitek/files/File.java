...
public class File extends FileSystemItemBase implements InterfaceFile {

    private int size = 0;
    private boolean isOpen = false;
    private int position = 0;

    public File(InterfaceDirectory parent, String name) {
        super(parent, name);
    }
    ...
    public FileSystemItem convertMp3ToWav() {
        ...
        InterfaceFile result = new File(parent, newFileName);
        result.open();
